...
function WhatWeDo() {
  return (
    <>
      ...
      <div className="flex justify-center items-center md:px-24 px-5 pt-12">
            ...
            <div className="p-3">
              ...
              <div className="mt-4">
                ...
                <p className="text-sm mt-2">
                  Meticulously plan and execute a diverse range of events, from
                  workshops to hosting challenges, fostering hands-on learning
                  experiences.
                </p>
              </div>
            </div>
